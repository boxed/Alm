...
pub fn values() -> &'static [BuiltinValue] {
    ...
    VALUES.get_or_init(|| {
        ...
        table.extend([
            ...
            V("Task", "map3", "(a -> b -> c -> result) -> Task x a -> Task x b -> Task x c -> Task x result"),
            V("Task", "map4", "(a -> b -> c -> d -> result) -> Task x a -> Task x b -> Task x c -> Task x d -> Task x result"),
            V("Task", "map5", "(a -> b -> c -> d -> e -> result) -> Task x a -> Task x b -> Task x c -> Task x d -> Task x e -> Task x result"),
            ...
            V("File", "lastModified", "File -> Time.Posix"),
            V("File", "toString", "File -> Task x String"),
            V("File", "toBytes", "File -> Task x Bytes.Bytes"),
            V("File", "toUrl", "File -> Task x String"),
            // Url
