...
fn collection_symbol(module: &str, name: &str) -> Option<&'static str> {
    Some(match (module, name) {
        ...
        // robinheghan/elm-deque: the finger-tree source is never compiled (its
        // type is non-regular); `Deque.*` routes to native kernels over an
        // opaque `Value::Deque`. See native_runtime `deque_*`.
        ("Deque", "empty") => "deque_empty",
        ("Deque", "singleton") => "deque_singleton",
        ("Deque", "isEmpty") => "deque_is_empty",
        ("Deque", "length") => "deque_length",
        ("Deque", "pushFront") => "deque_push_front",
        ("Deque", "pushBack") => "deque_push_back",
        ("Deque", "popFront") => "deque_pop_front",
        ("Deque", "popBack") => "deque_pop_back",
        ("Deque", "first") => "deque_first",
        ("Deque", "last") => "deque_last",
        ("Deque", "fromList") => "deque_from_list",
        ("Deque", "toList") => "deque_to_list",
        ("Deque", "append") => "deque_append",
        ("Deque", "member") => "deque_member",
        ("Deque", "equals") => "deque_equals",
        ("Deque", "initialize") => "deque_initialize",
        ("Deque", "repeat") => "deque_repeat",
        ("Deque", "range") => "deque_range",
        ("Deque", "left") => "deque_left",
        ("Deque", "right") => "deque_right",
        ("Deque", "dropLeft") => "deque_drop_left",
        ("Deque", "dropRight") => "deque_drop_right",
        ("Deque", "foldl") => "deque_foldl",
        ("Deque", "foldr") => "deque_foldr",
        ("Deque", "map") => "deque_map",
        ("Deque", "filter") => "deque_filter",
        ("Deque", "filterMap") => "deque_filter_map",
